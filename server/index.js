...
// app.use(helmet());
// app.use(helmet.crossOriginResourcePolicy({ policy: "cross-origin" })); //allow us to make cross origin sharing request
// app.use(morgan("common")); //need if we need to call api from another server
